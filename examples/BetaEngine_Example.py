...
if __name__ == "__main__":
    ...
    # #plt.errorbar(x, Engine.spectralist[521340], yerr=Engine.spectUncList[521340])
    # fig = plt.figure()
    # plt.fill_between(x, Engine.istplist[390960].spectrum+Engine.istplist[390960], Engine.istplist[390960].spectrum-Engine.istplist[390960], alpha=.5, linewidth=0)
    # fig.savefig("Y-96s.png")
    # fig = plt.figure()
    # plt.fill_between(x, Engine.spectralist[390960].spectrum+Engine.istplist[390960], Engine.istplist[390960].spectrum-Engine.istplist[390960], alpha=.5, linewidth=0)
