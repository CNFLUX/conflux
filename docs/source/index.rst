...
.. toctree::
   ...
   installation #<< How to install and execute the program
...
.. toctree::
   ...
   Intro #<<What does the code do
   Modes #<<Description of the different measurement modes
   Input #<<What inputs does the code take
