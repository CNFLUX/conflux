...
#     modelFullSpec.AddContribution(isotope=U238, Ei=0.5, fraction=1/4)
#     modelFullSpec.AddContribution(isotope=Pu239, Ei=0, fraction=1/4)
...
#     resultFullSpec.Draw("equal Model")
#
#
...
#-------------------------------------------------------------------
    ...
    modelIndBB.AddIstp(37, 92, 1)
    modelIndBB.AddIstp(37, 93, 1)
    modelIndBB.AddIstp(38, 95, 1)
    modelIndBB.AddIstp(39, 96, 1)
    modelIndBB.AddIstp(39, 97, 1)
    modelIndBB.AddIstp(41, 100, 1)
    modelIndBB.AddIstp(55, 140, 1)
    modelIndBB.AddIstp(55, 142, 1)
    ...
    resultIndBB.Draw("Dwyer-Langford Isotopes", summing = False, logy = False, frac=True)
...
#-----------------------------------------------------------------
    ...
    modelComb.AddContribution(isotope=Pu239, Ei=0, fraction=0.25)
